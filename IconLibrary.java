...
public class IconLibrary implements Constants{
    ...
    public IconLibrary (){
        ...
        try {
            ...
            icon.put (BOX   , ImageIO.read(getClass().getResource("source/barrel.png")));
            icon.put (ROAD  , ImageIO.read(getClass().getResource("source/floor.png")));
            icon.put (GOAL  , ImageIO.read(getClass().getResource("source/goal.png")));
            icon.put (WALL  , ImageIO.read(getClass().getResource("source/wall2.png")));
